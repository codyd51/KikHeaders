...
@interface XCardPinnedList : PBGeneratedMessage {
	NSMutableArray* mutableCardUrlHashList; 
}
@property (retain) NSMutableArray* mutableCardUrlHashList; 
+(id)builder;
...
-(int)serializedSize;
-(BOOL)isInitialized;
-(void)setMutableCardUrlHashList:(id)arg1;
-(id)cardUrlHashList;
