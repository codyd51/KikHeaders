...
-(void)pickUsers:(id)arg1 preselectedUsers:(id)arg2 minSelect:(id)arg3 maxSelect:(int)arg4 ;
-(void)pickFilteredUsers:(id)arg1 filtered:(id)arg2 filterSelf:(id)arg3 minSelect:(BOOL)arg4 maxSelect:(int)arg5 ;
-(void)sendKikMessage:(id)arg1 toConversatio:(id)arg2 withReturnToSender:(BOOL)arg3 ;
-(void)sendKikMessage:(id)arg1 toUser:(id)arg2 withReturnToSender:(BOOL)arg3 ;
-(void)openConversation:(id)arg1 withReturnToSender:(BOOL)arg2 ;
-(void)openConversationWithUser:(id)arg1 withCallback:(id)arg2 ;
-(void)pickUsers:(id)arg1 preselectedUsers:(id)arg2 minSelect:(id)arg3 maxSelect:(int)arg4 ;
